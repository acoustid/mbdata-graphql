...
def create_app() -> Flask:
    ...
    @app.cli.command('create-schema', help='Initialize the MusicBrainz schema in the target database.')
    def create_schema() -> None:
        db.create_all()

    @app.cli.command('create-sample-data', help='Add sample Musicbrainz data to the target database.')
